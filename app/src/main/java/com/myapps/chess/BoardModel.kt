...
class BoardModel {
    ...
    val row1 = listOf(Square(1, 0, 'x', Piece('x', 'x')), Square(1, 1, 'w', Piece('c', 'b')), Square(1, 2, 'b', Piece('0', '0')), Square(1, 3, 'w', Piece('b', 'b')), Square(1, 4, 'b', Piece('0', '0')),Square(1, 5, 'w', Piece('0', '0')), Square(1, 6, 'b', Piece('b', 'b')), Square(1, 7, 'w', Piece('0', '0')), Square(1, 8, 'b', Piece('c', 'b')), Square(1, 9, 'x', Piece('x', 'x')))
    ...
    val row8 = listOf(Square(8, 0, 'x', Piece('x', 'x')), Square(8, 1, 'b', Piece('c', 'w')), Square(8, 2, 'w', Piece('0', '0')), Square(8, 3, 'b', Piece('b', 'w')), Square(8, 4, 'w', Piece('0', '0')),Square(8, 5, 'b', Piece('0', '0')), Square(8, 6, 'w', Piece('b', 'w')), Square(8, 7, 'b', Piece('0', '0')), Square(8, 8, 'w', Piece('c', 'w')), Square(8, 9, 'x', Piece('x', 'x')))
