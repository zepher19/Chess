...
class BoardModel {
    ...
    val row5 = listOf(Square(5, 0, 'x', Piece('x', 'x')), Square(5, 1, 'w', Piece('0', '0')), Square(5, 2, 'b', Piece('0', '0')), Square(5, 3, 'w', Piece('0', '0')), Square(5, 4, 'b', Piece('0', '0')),Square(5, 5, 'w', Piece('k', 'w')), Square(5, 6, 'b', Piece('0', '0')), Square(5, 7, 'w', Piece('0', '0')), Square(5, 8, 'b', Piece('0', '0')), Square(5, 9, 'x', Piece('x', 'x')))
    ...
    val row8 = listOf(Square(8, 0, 'x', Piece('x', 'x')), Square(8, 1, 'b', Piece('c', 'w')), Square(8, 2, 'w', Piece('n', 'w')), Square(8, 3, 'b', Piece('b', 'w')), Square(8, 4, 'w', Piece('q', 'w')),Square(8, 5, 'b', Piece('0', '0')), Square(8, 6, 'w', Piece('b', 'w')), Square(8, 7, 'b', Piece('n', 'w')), Square(8, 8, 'w', Piece('c', 'w')), Square(8, 9, 'x', Piece('x', 'x')))
